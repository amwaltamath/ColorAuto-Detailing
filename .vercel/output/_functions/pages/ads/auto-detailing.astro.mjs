...
📧 Get Free Quote
</a> </div> <p class="text-sm text-gray-500 mt-6">📍 562 S. Westgate Drive, Grand Junction, CO</p> </div> </section>  <div id="quote-modal" class="hidden"> ${renderComponent($$result2, "QuoteModal", QuoteModal, { "service": "Auto Detailing", "client:load": true, "client:component-hydration": "load", "client:component-path": "C:/colorautodetailing/src/components/features/QuoteModal.tsx", "client:component-export": "default" })} </div> ${renderScript($$result2, "C:/colorautodetailing/src/pages/ads/auto-detailing.astro?astro&type=script&index=0&lang.ts")} ` })}`;
